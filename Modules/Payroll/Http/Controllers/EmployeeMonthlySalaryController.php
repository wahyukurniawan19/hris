...
class EmployeeMonthlySalaryController extends AccountBaseController
{
    ...
    public function getSalary(Request $request)
    {
        ...
        if ($request->basicType == 'fixed') {
            ...
            $this->basicSalary = ($request->annualSalary) / 100 * $request->basicValue;
        }

        $this->annualSalary = $request->annualSalary * 12;
            ...
            foreach ($this->salaryGroup->salary_group->components as $component) {
                ...
                if ($component->component->component_type == 'earning') {
                    ...
                    if ($component->component->value_type == 'percent') {
                        $totalEarnings[] += ($request->annualSalary) / 100 * $component->component->component_value;
                    }
                    ...
                    if ($component->component->value_type == 'percent') {
                        $totalExpenses[] = ($request->annualSalary) / 100 * $component->component->component_value;
                    }
        ...
        if (!is_null($this->salaryGroup)) {
            foreach ($this->salaryGroup->salary_group->components as $component) {
                ...
                if ($component->component->component_type == 'earning') {
                    ...
                    if ($component->component->value_type == 'percent') {
                        $totalEarnings[] += ($this->employeeMonthlySalary->annual_salary) / 100 * $component->component->component_value;
                    }
                    ...
                    if ($component->component->value_type == 'percent') {
                        $totalExpenses[] = ($this->employeeMonthlySalary->annual_salary) / 100 * $component->component->component_value;
                    }
    ...
    public function editSalary($id)
    {
        ...
        if ($this->employeeMonthlySalary->basic_value_type == 'fixed') {
            ...
            $this->basicSalary = ($this->employeeMonthlySalary->annual_salary) / 100 * $this->employeeMonthlySalary->basic_salary;
        }
