...
class RequestAttendanceDataTable extends BaseDataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'Attendance Date' => ['data' => 'leave_date', 'name' => 'leaves.leave_date', 'title' => 'Attendance Date'],
            'Clock In' => ['data' => 'status', 'name' => 'leaves.status', 'title' => 'Clock In'],
            'Clock Out' => ['data' => 'status', 'name' => 'leaves.status', 'title' => 'Clock Out'],
            'Status' => ['data' => 'status', 'name' => 'leaves.status', 'title' => 'Status'],
